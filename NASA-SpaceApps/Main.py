...
# below, create a list of same length as c1, but filled with ones
moved = np.ones((len(c1)))  # boolean list with same length as c1

for c1_key, c1_val in c1:
    for c2_key, c2_val in c2:
